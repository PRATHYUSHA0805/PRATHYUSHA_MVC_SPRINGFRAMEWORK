...
<body>
   ...
   <form:errors path="department.*"></form:errors>
	<div id="header">
		<h2>
			<a href="/DepEmpApp?siteLanguage=en">English</a>|<a href="/DepEmpApp?siteLanguage=ja">Japanese</a>
		</h2>
	</div>
...
<c:if test="${homepage eq 'emppage'}">
	...
	<table border="2" style="width: 100%"background-color:#eee;>
		<thead>
		    <tr>
				<th colspan="3"  style="text-align: center"><h1>Employee Table</h1></th>
				<th colspan="2" style="text-align: center"> <a href="newEmployee"><h2>Add New Employee</h2></a></th>
			</tr>
			<tr>
				<th>EMPID</th>
				<th>DID</th>
