...
public class EmployeeController {
	...
	@RequestMapping(value = "/CreateEmployee", method = RequestMethod.POST)
	 public ModelAndView insertDepartment(@Valid @ModelAttribute Employee employee,BindingResult result) {
	...
	public ModelAndView saveEmployee(@Valid @ModelAttribute Employee employee,HttpServletRequest request) {
