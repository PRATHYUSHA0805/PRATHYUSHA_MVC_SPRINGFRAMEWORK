...
<p><a href="/SpringMvc_WebServices/submitAdmissionForm.html?siteTheme-green">Green</a>
<a href="/SpringMvc_WebServices/submitAdmissionForm.html?siteTheme-red">red</a></p>



<a href="/SpringMvc_WebServices/submitAdmissionForm.html?siteLanguage=en">English</a>
<a href="/SpringMvc_WebServices/submitAdmissionForm.html?siteLanguage=fr">French</a>
	<h1>${headerMessage}</h1>
	...
	<form action="/SpringMvc_WebServices/submitAdmissionForm.html"
		method="post">
		<table>
			<tr>
